...
3. SOSERE Settings Page: Selection Settings. Customize considered posts
...
== Changelog ==
= 3.1.5 =
* Bugfix: fix deprecated conversion from float
...
= 3.1.3 =
* Update: tested up to WordPress 6.4.3
* Bugfix: fix deprecaed functions with php 8.1

= 3.1.2 =
* Bugfix: fix version informations

= 3.1.1 =
* Bugfix: fix unserialization data handling
...
* Bugfix: JS code adjustments for jQuery 1.8 and newer 

= 2.9.7 =
* Update: tested up to WordPress 5.7
* Bugfix: fix empty variable notice
 
= 2.9.6 =
* Update: tested up to WordPress 5.5
 
= 2.9.5 =
* Update: tested up to WordPress 5.5.0

= 2.9.4 =
* Update: tested up to WordPress 5.2.1

= 2.9.3 =
* Update: tested up to WordPress 5.0.3

= 2.9.2 =
* Bugfix: session destroy fix
* Update: tested up to WordPress 4.9.8

= 2.9.1 =
* NEW: Data sources selection extendet 

= 2.9.0 =
* NEW: Data sources selection option 

= 2.8.2 =
* Bugfix: settings save fix

= 2.8.1 =
* Bugfix: output fix

= 2.8.0 =
* Update: tested up to WordPress 4.9.5
* NEW: Display option for (custom) page types

= 2.7.0 =
* Update: tested up to WordPress 4.8.1
* Bugfix: hide recommendations on front page

= 2.6.5 =
* Update: tested up to WordPress 4.7

= 2.6.4 =
* Update: tested up to WordPress 4.6.1

= 2.6.3 =
* Bugfix: fix selection of custom thumbnail sizes

= 2.6.2 =
* Update: tested up to WordPress 4.5.3

= 2.6.1 =
* Bugfix: update notice fixed 

= 2.6.0 =
* Update: extendet selection of custom thumbnail sizes
* Bugfix: cropping of thumbnails fixed  

= 2.5.6 =
* Update: strip tags in post titles
* Bugfix: set default language on single language sites  

= 2.5.5 =
* Bugfix: renamed po/mo files  to fit new text domain

= 2.5.4 =
* Bugfix: fix text domain 

= 2.5.3 =
* Bugfix: fix text domain for glotpress translations

= 2.5.2 =
* NEW: added pot file for 3rd party translators

= 2.5.1 =
* Bugfix: renamed po-files

= 2.5.0 =
* Update: translations updated 

= 2.4.4 =
* Update: tested up to WordPress 4.5.2

= 2.4.3 =
* Bugfix: css fix in admin settings section
* Bugfix: fixed recommendation box title 

= 2.4.2 =
* Bugfix: fix admin redirection incompatibility with NextCellent Gallery

= 2.4.1 =
* Bugfix: fix undefined variable notice

= 2.4.0 =
* NEW: multi language custom recommendation box titles 

= 2.3.7 =
* Bugfix: thumbnails in cropped size instead of original image
