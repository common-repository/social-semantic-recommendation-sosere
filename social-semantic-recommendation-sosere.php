 ...
 * Plugin URI: https://wordpress.org/plugins/social-semantic-recommendation-sosere
 ...
 */
 ...
 /*  Copyright 2016  Arthur Kaiser (email: social-semantic-recommendation@sosere.com)
...
/*
* Description reference for social-semantic-recommendation-sosere
*/
$dump = __( 'SOSERE displays a list or thumbnails of related entries at the bottom of a post based on an unique, self-learning, socialsemantic analysis algorithm. It is efficient and fits perfect to each post individually.', 'social-semantic-recommendation-sosere' );
...
if( ! class_exists( 'Social_Semantic_Reommendation_SOSERE' ) ) {
	...
	class Social_Semantic_Recommendation_SOSERE
	{
		...
		public function __construct() {
			...
			// load langs
			add_action('init', array($this, 'load_langs'));
		...
		public function load_langs(){
			// load langs
			if(!is_textdomain_loaded('social-semantic-recommendation-sosere'))
				{
					// load langs
					load_plugin_textdomain( 'social-semantic-recommendation-sosere', false, SOSERE_PLUGIN_SUBDIR . '/sosere_languages/' );
				}
		}
